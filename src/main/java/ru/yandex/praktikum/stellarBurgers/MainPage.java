...
public class MainPage {
  ...
  private static final SelenideElement fluorescentBunButton = $x(".//p[text()='Флюоресцентная булка R2-D3']");
  ...
  private static final SelenideElement shellfishMeatButton = $x(".//p[text()='Мясо бессмертных моллюсков Protostomia']");
