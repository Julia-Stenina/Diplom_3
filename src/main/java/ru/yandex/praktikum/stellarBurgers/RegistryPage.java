...
public class RegistryPage {
    ...
    @As("Поле [Имя]")
    private static final SelenideElement nameField = $x(
        ".//label[text()='Имя']/following::input[1]");
    ...
    private static final SelenideElement wrongPasswordSign = $x(
        ".//p[text()='Некорректный пароль']");

    @As("Кнопка [Зарегистрироваться]")
    private static final SelenideElement registryButton = $x(
    ...
    public static void fillInRegistryForm(String nameValue, String emailValue,
